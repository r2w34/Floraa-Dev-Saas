    ...
    <RadixDialog.Root open={open}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content asChild>
          <motion.div
            className="fixed top-[50%] left-[50%] z-max h-[85vh] w-[90vw] max-w-[900px] translate-x-[-50%] translate-y-[-50%] border border-floraa-elements-borderColor rounded-lg shadow-lg focus:outline-none overflow-hidden"
            initial="closed"
            animate="open"
            exit="closed"
            ...
            <div className="flex h-full">
              <div
                className={classNames(
                  'w-48 border-r border-floraa-elements-borderColor bg-floraa-elements-background-depth-1 p-4 flex flex-col justify-between',
                  styles['settings-tabs'],
                )}
              >
                <DialogTitle className="flex-shrink-0 text-lg font-semibold text-floraa-elements-textPrimary mb-2">
                  Settings
                </DialogTitle>
                {tabs.map((tab) => (
                  <button
              ...
              <div className="flex-1 flex flex-col p-8 pt-10 bg-floraa-elements-background-depth-2">
