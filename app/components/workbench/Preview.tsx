...
export const Preview = memo(() => {
  ...
  return (
    <div ref={containerRef} className="w-full h-full flex flex-col relative">
      ...
      <div className="bg-floraa-elements-background-depth-2 p-2 flex items-center gap-1.5">
        <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />

        <div
          className="flex items-center gap-1 flex-grow bg-floraa-elements-preview-addressBar-background border border-floraa-elements-borderColor text-floraa-elements-preview-addressBar-text rounded-full px-3 py-1 text-sm hover:bg-floraa-elements-preview-addressBar-backgroundHover hover:focus-within:bg-floraa-elements-preview-addressBar-backgroundActive focus-within:bg-floraa-elements-preview-addressBar-backgroundActive
        focus-within-border-floraa-elements-borderColorActive focus-within:text-floraa-elements-preview-addressBar-textActive"
        >
          <input
            ref={inputRef}
      ...
      <div className="flex-1 border-t border-floraa-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
