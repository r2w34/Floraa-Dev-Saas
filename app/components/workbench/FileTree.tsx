  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-floraa-elements-item-contentDefault hover:text-floraa-elements-item-contentActive hover:bg-floraa-elements-item-backgroundActive':
          !selected,
        'bg-floraa-elements-item-backgroundAccent text-floraa-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-floraa-elements-item-backgroundActive text-floraa-elements-item-contentDefault': !selected,
        'bg-floraa-elements-item-backgroundAccent text-floraa-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-floraa-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
