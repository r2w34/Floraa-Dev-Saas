              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={classNames('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-floraa-elements-textTertiary hover:text-floraa-elements-textPrimary': !isActive,
                    'text-floraa-elements-textPrimary underline': isActive,
                    'pr-4': isLast,
                  })}
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-floraa-elements-background-depth-1 border border-floraa-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
