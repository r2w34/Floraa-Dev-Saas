...
export const ModelSelector = ({
  ...
  if (enabledProviders.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-floraa-elements-borderColor bg-floraa-elements-prompt-background text-floraa-elements-textPrimary">
  ...
  return (
    <div className="mb-2 flex gap-2 flex-col sm:flex-row">
      <select
        ...
        className="flex-1 p-2 rounded-lg border border-floraa-elements-borderColor bg-floraa-elements-prompt-background text-floraa-elements-textPrimary focus:outline-none focus:ring-2 focus:ring-bolt-elements-focus transition-all"
      >
      ...
      <select
        ...
        className="flex-1 p-2 rounded-lg border border-floraa-elements-borderColor bg-floraa-elements-prompt-background text-floraa-elements-textPrimary focus:outline-none focus:ring-2 focus:ring-bolt-elements-focus transition-all lg:max-w-[70%]"
      >
        {[...modelList]
