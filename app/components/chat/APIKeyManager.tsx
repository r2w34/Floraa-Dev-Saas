...
export const APIKeyManager: React.FC<APIKeyManagerProps> = ({ provider, apiKey, setApiKey }) => {
  ...
  return (
    <div className="flex items-start sm:items-center mt-2 mb-2 flex-col sm:flex-row">
      <div>
        <span className="text-sm text-floraa-elements-textSecondary">{provider?.name} API Key:</span>
        {!isEditing && (
          <div className="flex items-center mb-4">
            <span className="flex-1 text-xs text-floraa-elements-textPrimary mr-2">
      ...
      {isEditing ? (
        <div className="flex items-center gap-3 mt-2">
          <input
            ...
            className="flex-1 px-2 py-1 text-xs lg:text-sm rounded border border-floraa-elements-borderColor bg-floraa-elements-prompt-background text-floraa-elements-textPrimary focus:outline-none focus:ring-2 focus:ring-bolt-elements-focus"
          />
